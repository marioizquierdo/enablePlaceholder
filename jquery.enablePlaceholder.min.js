...
input.bind('focus keydown paste',function(){clearPlaceholder(input,placeholder);});input.bind('blur',function(){if(input.val()==""){showPlaceholder(input,placeholder);}});input.parents('form').first().submit(function(){clearPlaceholder(input,placeholder);return true;});}});};};})(jQuery)